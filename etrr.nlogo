...
to setup-the-cars ;; e-cars are mobile turtles on the streets
  ...
  ;;-----------------------------------------------------------------------
  ;
  ;; Experience 4 (two groups with .3 et .7 respectively and A/B-ratio=.9)
  if (EXPERIENCE = "exp4") [
  ...
  ;; to track the first e-car
  ;ask e-car 0 [pendown set size 3]
end ;; setup-the-cars
...
283
P_out with dod=.3
count e-cars with [c-state = \"OUT_OF_SERVICE\" and car-range-ratio-threshold = 0.3 ]  / count e-cars with [car-range-ratio-threshold = 0.3 ]
3
1
11
...
345
P_out with dod=.7
count e-cars with [c-state = \"OUT_OF_SERVICE\" and car-range-ratio-threshold = 0.7 ]  / count e-cars with [car-range-ratio-threshold = 0.7 ]
3
1
11
